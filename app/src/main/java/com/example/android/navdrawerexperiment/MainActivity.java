    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_orders:
                ...
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_orders));
                return true;
            case R.id.nav_account:
                // Handle the gallery action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_account));
                return true;
            case R.id.nav_wishlist:
                // Handle the slideshow action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_wishlist));
                return true;
            case R.id.nav_cart:
                // Handle the tools action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_cart));
                return true;
            case R.id.nav_deals:
                // Handle the share action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_deals));
                return true;
            case R.id.nav_help:
                // Handle the send action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_help));
                return true;
            ...
            case R.id.nav_notifications:
                // Handle the send action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_notifications));
                return true;
            case R.id.nav_payment:
                // Handle the send action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_payment));
                return true;
            case R.id.nav_about:
                // Handle the send action (for now display a toast).
                drawer.closeDrawer(GravityCompat.START);
                displayToast(getString(R.string.chose_about));
                return true;
            default:
                return false;
        }
